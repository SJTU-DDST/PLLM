...
原始 JSON、CSV、日志和 PNG 位于 `exp/kv_pause_20260719/` 与 `exp/host_moe_resume_20260719/`；Recent-32 的独立报告位于 `exp/moe_decode_locality_20260719/better_strategy/report.md`。
